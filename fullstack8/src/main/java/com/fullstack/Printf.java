...
public class Printf {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Hello %s", "concatenando");
		System.out.println();
		System.out.printf("Hello %S", "concatenando em caixa alta");
		System.out.println();
		...
		double pontoFlutuante = 3.969778;
	...
	private static void testeMaisCompleto() {
		...
		for (int i=0; i<precos.length; i++) {
			...
			// isso é uma brincadeira na vida real você vai usar : Java.util.Formater
		}
	}
